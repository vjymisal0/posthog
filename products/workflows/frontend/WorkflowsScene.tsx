...
export interface workflowsSceneLogicActions {
    setCurrentTab: (tab: WorkflowsSceneTab) => {
        tab: 'broadcasts' | 'channels' | 'library' | 'opt-outs' | 'reputation' | 'suppression' | 'workflows'
    }
}
...
export interface workflowsSceneLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        breadcrumbs: (
            currentTab: 'broadcasts' | 'channels' | 'library' | 'opt-outs' | 'reputation' | 'suppression' | 'workflows'
        ) => Breadcrumb[]
    }
}
