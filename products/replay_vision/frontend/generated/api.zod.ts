    ...
    selection: zod
        .object({
            ...
            min_score: zod
                .number()
                .optional()
                .describe('Minimum scorer score (inclusive). Requires succeeded-only statuses.'),
            max_score: zod
                .number()
                .optional()
                .describe('Maximum scorer score (inclusive). Requires succeeded-only statuses.'),
            statuses: zod
                .array(zod.enum(['succeeded', 'failed']).describe('\* `succeeded` - Succeeded\n\* `failed` - Failed'))
                .optional()
                .describe(
